...
const AIChatInterface = () => {
    ...
    return (
        ...
        >
            {/* Search Input — always visible, no card bg */}
            <form onSubmit={handleSubmit}>
                <div className="flex items-center gap-3 rounded-xl bg-white border border-gray-200 px-4 py-3 shadow-lg">
                    ...
                    <input
                        ...
                        placeholder="Ask me anything about DIA.AI... What do you need help with?"
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {isExpanded ? (
                            ...
                            <button type="submit" className="p-1.5 rounded-lg hover:bg-gray-100 transition">
            ...
            <AnimatePresence>
                {isExpanded && (
                    <motion.div
                        ...
                        className="mt-3 rounded-xl bg-white border border-gray-200 shadow-xl p-6"
                    >
