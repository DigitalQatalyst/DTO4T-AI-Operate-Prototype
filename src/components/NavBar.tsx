...
const NavBar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 z-50 w-full text-white transition-all duration-300 ${scrolled ? "backdrop-blur-md shadow-lg border-b border-white/10" : "border-b border-white/5"}`}
        style={{ backgroundColor: '#0a1f4d' }}
      >
        <div className="flex w-full items-center py-3">
          {/* Logo */}
          <a className="px-6 flex items-center transition-all duration-300" href="/">
            <span className="text-xl font-bold text-white tracking-tight">DIA.AI</span>
          </a>

          {/* Main Nav */}
          <div className="flex-1 flex justify-between items-center bg-transparent px-6 transition-all duration-300">
            {/* Left — Explore */}
