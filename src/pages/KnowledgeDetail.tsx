...
import { mockItems } from '@/data/knowledgeMarketplace';
      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/knowledge" className="text-blue-600 hover:underline mt-4 inline-block">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/knowledge" className="hover:text-gray-900">Knowledge Base</Link>
              <ChevronRight className="h-3.5 w-3.5" />
              ...
              <div className="bg-white rounded-lg border border-gray-200">
                <div className="border-b border-gray-200">
                  <div className="flex gap-0">
                    {['overview', 'details', 'resources'].map(tab => (
                      <button
                        key={tab}
                  ...
                  {!showFullContent ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Login to access the full knowledge base content.
                      </p>
                      <button
                      ...
                      {activeTab === 'details' && (
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                              Comprehensive details and documentation will be available here.
                            </p>
                          </div>
                        </div>
                      )}
