...
import { mockItems } from '@/data/glossaryMarketplace';
      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/glossary" className="text-blue-600 hover:underline mt-4 inline-block">
              ← Back to AI Glossary
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/glossary" className="hover:text-gray-900">AI Glossary</Link>
              <ChevronRight className="h-3.5 w-3.5" />
                  ...
                  {!showFullContent ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Login to access the full glossary definition and detailed explanations.
                      </p>
                      <button
                      ...
                      {activeTab === 'details' && (
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                              This section provides comprehensive details about the term.
                            </p>
                          </div>
                        </div>
                      )}
