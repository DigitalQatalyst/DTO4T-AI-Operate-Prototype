...
const AIOpsFrameworkMarketplace = () => {
  ...
  const searchPlaceholders: Record<string, string> = {
    'governance-models': 'Search governance models... e.g., operating model, RACI',
    'lifecycle-standards': 'Search lifecycle standards... e.g., intake, release gates',
    'accountability-frameworks': 'Search accountability frameworks... e.g., approvals, escalation',
    'responsible-ai-policies': 'Search policies... e.g., risk controls, transparency'
  };

  const autoRefreshTabs = ['governance-models', 'lifecycle-standards'];
