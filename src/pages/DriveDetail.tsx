...
import { mockItems } from '@/data/driveMarketplace';
      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/drive" className="text-blue-600 hover:underline mt-4 inline-block">
              ← Back to Drive Marketplace
            </Link>
          </div>
        </div>
        <Footer />
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/drive" className="hover:text-gray-900">Drive Marketplace</Link>
              <ChevronRight className="h-3.5 w-3.5" />
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed">
                              This {typeLabels[item.type].toLowerCase()} capability provides critical operational support for enterprise AI. 
                              The solution has been reviewed and approved by the {item.ownerTeam} team to ensure alignment 
