    ...
    <>
      ...
      <div className="min-h-screen text-white" style={{ backgroundColor: '#0d2a5e' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="mb-8">
            <span className="inline-block px-3 py-1 bg-deploy/20 text-deploy text-xs font-bold uppercase tracking-wider rounded-full mb-4">
              MARKETPLACE
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {marketplaces.map((marketplace, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#111827] border border-white/15 rounded-xl p-6 flex flex-col hover:border-deploy/50 transition-all duration-300"
                >
                  {/* Icon */}
                  <div className="w-12 h-12 bg-deploy rounded-lg flex items-center justify-center mb-4">
                    <Icon className="h-6 w-6 text-white" />
                  </div>

                  {/* Category Tag */}
                  <span className="inline-block px-2 py-1 bg-deploy text-white text-[10px] font-bold uppercase tracking-wider rounded mb-3 self-start">
                    {marketplace.tag}
                  </span>
