...
import { tabs, mockItems } from '@/data/knowledgeMarketplace';
...
const KnowledgeMarketplace = () => {
  ...
  const searchPlaceholders: Record<string, string> = {
    'policies':        'Search policies… e.g., acceptable use, governance',
    'best-practices':  'Search best practices… e.g., prompts, patterns',
    'case-studies':    'Search case studies… e.g., HR, finance',
    'documentation':   'Search documentation… e.g., guides, technical',
  };

  useEffect(() => {
    let items = [...mockItems];
    
    // Filter by active tab using type (Knowledge has different types per tab)
      ...
      <div className="min-h-screen bg-white pt-16">
        <div className="bg-gray-50 border-b border-gray-100">
          <div className={`${px} py-2.5`}>
            <Breadcrumb pageName="AI Knowledge Center" />
          </div>
        </div>
        ...
        <div className={`${px} pt-5 pb-0`}>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Strategy, policies, guardrails, and governance documentation for AI adoption.
          </p>
          <div className="mt-4">
            <TabNavigation
              tabs={tabs}
