...
import { mockItems } from '@/data/communityMarketplace';
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/community" className="hover:text-gray-900">Community Hub</Link>
              <ChevronRight className="h-3.5 w-3.5" />
              ...
              <div className="bg-white rounded-lg border border-gray-200">
                <div className="border-b border-gray-200">
                  <div className="flex gap-0">
                    {['overview', 'details', 'participants'].map(tab => (
                      <button
                        key={tab}
                  ...
                  {!showFullContent ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Login to access the full event details and registration.
                      </p>
                      <button
                      ...
                      {activeTab === 'details' && (
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                              Detailed event information, agenda, and logistics will be available here.
                            </p>
                          </div>
                        </div>
                      )}
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.topic.map(topic => (
                    <span key={topic} className="px-3 py-1 bg-orange-50 text-orange-700 text-xs font-medium rounded-full">
                      {topic}
                    </span>
                  ))}
                </div>
