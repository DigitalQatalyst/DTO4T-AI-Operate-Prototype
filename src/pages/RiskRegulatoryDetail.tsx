...
import { mockItems } from '@/data/riskRegulatoryMarketplace';
...
const RiskRegulatoryDetail = () => {
      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/risk-regulatory" className="text-blue-600 hover:underline mt-4 inline-block">
              ← Back to Risk & Regulatory
            </Link>
          </div>
        </div>
        <Footer />
  ...
  const typeLabels: Record<string, string> = {
    insight: 'Risk & Regulatory Insight',
  };
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 pt-16">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/risk-regulatory" className="hover:text-gray-900">Risk & Regulatory</Link>
              <ChevronRight className="h-3.5 w-3.5" />
        ...
        <div className="max-w-7xl mx-auto px-16 pt-6">
          <button 
            onClick={() => navigate('/risk-regulatory')}
                  ...
                  {!showFullContent ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Login to access the full risk and regulatory content.
                      </p>
                      <button
                      ...
                      {activeTab === 'details' && (
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                              This section provides comprehensive details about the risk and regulatory requirements.
                            </p>
                          </div>
                        </div>
                      )}
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.topic.map(topic => (
                    <span key={topic} className="px-3 py-1 bg-red-50 text-red-700 text-xs font-medium rounded-full">
                      {topic}
                    </span>
                  ))}
                </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {mockItems.filter(i => i.id !== id).slice(0, 3).map(relatedItem => (
                <Link
                  key={relatedItem.id}
                  to={`/risk-regulatory/${relatedItem.id}`}
...
export default RiskRegulatoryDetail;
