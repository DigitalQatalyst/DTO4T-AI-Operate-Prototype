...
import { tabs, mockItems } from '@/data/experimentTrackingMarketplace';
...
const ExperimentTrackingMarketplace = () => {
  ...
  const searchPlaceholders: Record<string, string> = {
    'experiment-tracking': 'Search experiment tracking... e.g., hyperparameters, metrics',
    'model-registry': 'Search model registry... e.g., versioning, lineage',
    'reproducibility': 'Search reproducibility tools... e.g., environment, data versioning',
    'approval-workflows': 'Search approval workflows... e.g., quality gates, validation'
  };

  const autoRefreshTabs = ['experiment-tracking', 'model-registry'];
      ...
      <div className="min-h-screen bg-white pt-16">
        ...
        <div className="bg-gray-50 border-b border-gray-100">
          <div className={`${px} py-2.5`}>
            <Breadcrumb pageName="Experiment Tracking & Model Registry" section="Deploys" />
          </div>
        </div>

        {/* Page title + subtitle + tabs */}
        <div className={`${px} pt-5 pb-0`}>
          <h1 className="text-2xl font-bold text-gray-900">Experiment Tracking & Model Registry</h1>
          <p className="mt-1 text-sm text-gray-500">
            Comprehensive tracking, reproducibility, and approval workflows for AI experiments and models.
          </p>
          <div className="mt-4">
            <TabNavigation
              tabs={tabs}
        ...
        <div className={`${px} pb-10`}>
          <div className="flex gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <CardGrid items={filteredItems} basePath="/experiment-tracking" />
            </div>
          </div>
        </div>
...
export default ExperimentTrackingMarketplace;
