...
import { mockItems } from '@/data/learningMarketplace';
      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/learning" className="text-blue-600 hover:underline mt-4 inline-block">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/learning" className="hover:text-gray-900">Learning Hub</Link>
              <ChevronRight className="h-3.5 w-3.5" />
                  ...
                  {!showFullContent ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Login to access the full learning content and materials.
                      </p>
                      <button
                      ...
                      {activeTab === 'curriculum' && (
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed mb-4">
                              Detailed curriculum and learning modules will be available here.
                            </p>
                          </div>
                        </div>
                      )}
