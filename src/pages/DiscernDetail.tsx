      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/discern" className="text-blue-600 hover:underline mt-4 inline-block">
              ← Back to Marketplace
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/discern" className="hover:text-gray-900">AI Updates & Insights Center</Link>
              <ChevronRight className="h-3.5 w-3.5" />
                  ...
                  {!showFullContent ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Login to access the full content details, technical specifications, and impact assessment.
                      </p>
                      <button
                    ...
                    <>
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed">
                              This {typeLabels[item.type].toLowerCase()} provides critical information for enterprise AI operations. 
                              The content has been reviewed and approved by the {item.ownerTeam} team to ensure alignment 
                              with governance standards and operational requirements.
                            </p>
                          </div>
                          ...
                          <div>
                            ...
                            <ul className="space-y-2">
                              ...
                              {item.impact && (
                                <li className="flex items-start gap-2">
                                  <CheckCircle2 className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                                  <span className="text-gray-700">Impact level: {item.impact}</span>
                                </li>
                              )}
                            </ul>
                          </div>
                          ...
                          {item.type === 'update' && (
                            <div>
                              <h3 className="text-lg font-bold text-gray-900 mb-3">What's Changed</h3>
                              <p className="text-gray-700 leading-relaxed mb-3">
                                This platform update introduces enhanced capabilities across the enterprise AI infrastructure:
                              </p>
                              <ul className="space-y-2 ml-4">
                                <li className="text-gray-700">• Enhanced context awareness for improved decision support</li>
                                <li className="text-gray-700">• Improved response quality with better accuracy and relevance</li>
                                <li className="text-gray-700">• Strengthened governance controls for responsible AI usage</li>
                                <li className="text-gray-700">• Updated monitoring and audit capabilities</li>
                              </ul>
                            </div>
                          )}
                        </div>
                      ...
                      {activeTab === 'impact' && (
                        <div className="space-y-6">
                          <div>
                            <h2 className="text-xl font-bold text-gray-900 mb-4">Impact Assessment</h2>
                            <p className="text-gray-700 leading-relaxed mb-4">
                              Understanding the organizational impact of this {typeLabels[item.type].toLowerCase()}.
                            </p>
                          </div>

                          <div>
                            <h3 className="text-lg font-bold text-gray-900 mb-3">Affected Stakeholders</h3>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.topic.map(topic => (
                    <span key={topic} className="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full">
                      {topic}
                    </span>
                  ))}
                </div>
