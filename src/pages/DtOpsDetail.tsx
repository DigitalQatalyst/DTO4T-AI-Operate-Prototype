...
import { mockItems } from '@/data/dtOpsMarketplace';
      ...
      <>
        ...
        <div className="min-h-screen bg-white pt-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/dtops" className="text-blue-600 hover:underline mt-4 inline-block">
              ← Back to Digital Twin Ops (DTOps)
            </Link>
          </div>
        </div>
        <Footer />
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-16 py-3">
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <ChevronRight className="h-3.5 w-3.5" />
              <Link to="/dtops" className="hover:text-gray-900">Digital Twin Ops (DTOps)</Link>
              <ChevronRight className="h-3.5 w-3.5" />
