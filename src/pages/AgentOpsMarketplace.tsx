...
import { tabs, mockItems } from '@/data/agentOpsMarketplace';
      ...
      <div className="min-h-screen bg-white pt-16">
        ...
        <div className="bg-gray-50 border-b border-gray-100">
          <div className={`${px} py-2.5`}>
            <Breadcrumb pageName="Agent Lifecycle Management (AgentOps)" section="Deploys" />
          </div>
        </div>

        {/* Page title + subtitle + tabs */}
        <div className={`${px} pt-5 pb-0`}>
          <h1 className="text-2xl font-bold text-gray-900">Agent Lifecycle Management (AgentOps)</h1>
          <p className="mt-1 text-sm text-gray-500">
            Governed lifecycle management for autonomous AI agents and agentic systems.
          </p>
          <div className="mt-4">
            <TabNavigation
              tabs={tabs}
        ...
        <div className={`${px} pb-10`}>
          <div className="flex gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <CardGrid items={filteredItems} basePath="/agentops" />
            </div>
          </div>
        </div>
...
export default AgentOpsMarketplace;
